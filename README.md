...
* * * * * /usr/bin/env php8.0 -f "/home/chatbot/cron.php" 1>/dev/nu$

*/10 * * * * /usr/bin/env php8.0 -f "/home/chatbot/cron/cache_cron.php" 1>/dev/nu$

0 12 30 8 * /usr/bin/env php8.0 -f "/home/chatbot/clear_all.php" 1>/dev/nu$
